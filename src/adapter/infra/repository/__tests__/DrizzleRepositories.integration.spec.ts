...
import { DrizzleUserRepository, DrizzleVideoJobRepository } from '../DrizzleRepositories';
...
describe('DrizzleRepositories integration', () => {
  ...
  describe('DrizzleVideoJobRepository', () => {
    ...
    it('marks a job as processing, completed, and failed', async () => {
      ...
      const completed = await videoJobs.markCompleted(created.id, 'zips/state.zip');
